...
const he = {
  ...
  wormsWeaponInfo: {
    bazooka: 'טיל רגיל. החזיקו אש לטעינת עוצמת הירי. מושפע מרוח.',
    grenade: 'רימון מתגלגל. כוונו, קבעו פתיל (1-5 שנ\') והחזיקו אש לשיגור.',
...
const en: Dict = {
  ...
  wormsWeaponInfo: {
    bazooka: 'Standard rocket. Hold FIRE to charge launch power. Affected by wind.',
    grenade: 'Bouncy explosive. Set fuse (1-5s) with F, then hold FIRE to launch.',
