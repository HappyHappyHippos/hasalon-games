...
const he = {
  ...
  wormsWeaponInfo: {
    ...
    bat: 'מכה מקרוב המעיפה תולעים רחוק על המפה.',
    cluster: 'מתפוצץ בפגיעה ומתפצל ל-5 פצצונות קטנות.',
    dynamite: 'חומר נפץ חזק המונח לרגליכם עם פתיל של 4 שניות.',
    homing: 'לחצו על מיקום במפה לסמן יעד, ואז שגרו את הטיל לכוון היעד.',
    mine: 'מוקש נגד אדם. מונח לרגליכם ומתפוצץ כשתולע מתקרב.',
...
const en: Dict = {
  ...
  wormsWeaponInfo: {
    ...
    bat: 'Melee attack that flings target worms across the battlefield.',
    cluster: 'Explodes on impact, splitting into 5 smaller sub-bomblets.',
    dynamite: 'Heavy explosive dropped at your feet with a 4-second fuse.',
    homing: 'Tap target spot on map, then launch missile towards the target.',
    mine: 'Spiked landmine dropped at your feet. Explodes when worms walk close.',
