...
const he = {
  ...
  telephoneGood: 'טוב',
  telephoneMeh: 'ככה ככה',
  telephoneBad: 'רע',
  telephoneVoteTitle: 'מה דעתכם על הציור?',
  telephoneYours: 'זה הציור שלכם — אי אפשר להצביע',
  telephoneBallots: (n: number, of: number) => `${n} מתוך ${of} הצביעו`,
  telephoneBy: (name: string) => `ציור של ${name}`,
  telephoneAward: (n: number) => `+${n} נקודות`,
  telephoneNoText: 'לא נכתב דבר',
  telephoneMysteryArtist: 'האמן המסתורי',
...
const en: Dict = {
  ...
  telephoneMeh: 'Meh',
  telephoneBad: 'Bad',
  telephoneVoteTitle: 'How is this drawing?',
  telephoneYours: "This is your drawing — you can't vote",
  telephoneBallots: (n: number, of: number) => `${n} of ${of} voted`,
  telephoneBy: (name: string) => `drawn by ${name}`,
  telephoneAward: (n: number) => `+${n} points`,
  telephoneNoText: 'Nothing was submitted',
  telephoneMysteryArtist: 'Mystery artist',
