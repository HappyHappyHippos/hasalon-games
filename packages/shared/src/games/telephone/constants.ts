...
export const INTRO_TICKS = seconds(2); export const TEXT_REVEAL_TICKS = seconds(2); export const DRAWING_REVEAL_TICKS = seconds(2); export const CHAIN_COMPLETE_TICKS = seconds(7); export const POINTS_PER_LIKE = 1;
