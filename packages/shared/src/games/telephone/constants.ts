...
export const INTRO_TICKS = seconds(2); export const TEXT_REVEAL_TICKS = seconds(3); export const DRAWING_REVEAL_TICKS = seconds(2); export const RESULT_TICKS = seconds(4.5); export const CHAIN_COMPLETE_TICKS = seconds(7); export const TOP_DRAWING_BONUS = 40;
