 ...
 *
 * Each race derives its own seed from the match seed and the race number, so
 * which track is drawn and which powerup a pad holds are reproducible from two
 * numbers rather than being sent.
 */
