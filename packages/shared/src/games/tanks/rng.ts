 ...
 *
 * Each round derives its arena seed from the match seed and the round number,
 * so the client can regenerate the maze from three numbers in the snapshot
 * instead of being sent the walls.
 */
